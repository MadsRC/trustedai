...
const (
	...
	UsageAnalyticsServiceName = "llmgw.v1.UsageAnalyticsService"
)
...
const (
	...
	UsageAnalyticsServiceGetUsageSummaryProcedure = "/llmgw.v1.UsageAnalyticsService/GetUsageSummary"
	...
	UsageAnalyticsServiceGetUsageDetailsProcedure = "/llmgw.v1.UsageAnalyticsService/GetUsageDetails"
	// UsageAnalyticsServiceGetUsageCostsProcedure is the fully-qualified name of the
	// UsageAnalyticsService's GetUsageCosts RPC.
	UsageAnalyticsServiceGetUsageCostsProcedure = "/llmgw.v1.UsageAnalyticsService/GetUsageCosts"
	...
	UsageAnalyticsServiceGetOrganizationUsageSummaryProcedure = "/llmgw.v1.UsageAnalyticsService/GetOrganizationUsageSummary"
	...
	UsageAnalyticsServiceGetOrganizationUsageByUserProcedure = "/llmgw.v1.UsageAnalyticsService/GetOrganizationUsageByUser"
	...
	UsageAnalyticsServiceGetOrganizationUsageByModelProcedure = "/llmgw.v1.UsageAnalyticsService/GetOrganizationUsageByModel"
)

// UsageAnalyticsServiceClient is a client for the llmgw.v1.UsageAnalyticsService service.
...
// NewUsageAnalyticsServiceClient constructs a client for the llmgw.v1.UsageAnalyticsService
...
func NewUsageAnalyticsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UsageAnalyticsServiceClient {
	...
	usageAnalyticsServiceMethods := v1.File_proto_madsrc_llmgw_v1_usage_analytics_proto.Services().ByName("UsageAnalyticsService").Methods()
...
// GetUsageSummary calls llmgw.v1.UsageAnalyticsService.GetUsageSummary.
...
// GetUsageDetails calls llmgw.v1.UsageAnalyticsService.GetUsageDetails.
...
// GetUsageCosts calls llmgw.v1.UsageAnalyticsService.GetUsageCosts.
...
// GetOrganizationUsageSummary calls llmgw.v1.UsageAnalyticsService.GetOrganizationUsageSummary.
...
// GetOrganizationUsageByUser calls llmgw.v1.UsageAnalyticsService.GetOrganizationUsageByUser.
...
// GetOrganizationUsageByModel calls llmgw.v1.UsageAnalyticsService.GetOrganizationUsageByModel.
...
// UsageAnalyticsServiceHandler is an implementation of the llmgw.v1.UsageAnalyticsService service.
...
func NewUsageAnalyticsServiceHandler(svc UsageAnalyticsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/llmgw.v1.UsageAnalyticsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUsageAnalyticsServiceHandler) GetUsageSummary(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetUsageSummaryRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetUsageSummaryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetUsageSummary is not implemented"))
}
...
func (UnimplementedUsageAnalyticsServiceHandler) GetUsageDetails(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetUsageDetailsRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetUsageDetailsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetUsageDetails is not implemented"))
}
...
func (UnimplementedUsageAnalyticsServiceHandler) GetUsageCosts(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetUsageCostsRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetUsageCostsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetUsageCosts is not implemented"))
}
...
func (UnimplementedUsageAnalyticsServiceHandler) GetOrganizationUsageSummary(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetOrganizationUsageSummaryRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetOrganizationUsageSummaryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetOrganizationUsageSummary is not implemented"))
}
...
func (UnimplementedUsageAnalyticsServiceHandler) GetOrganizationUsageByUser(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetOrganizationUsageByUserRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetOrganizationUsageByUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetOrganizationUsageByUser is not implemented"))
}
...
func (UnimplementedUsageAnalyticsServiceHandler) GetOrganizationUsageByModel(context.Context, *connect.Request[v1.UsageAnalyticsServiceGetOrganizationUsageByModelRequest]) (*connect.Response[v1.UsageAnalyticsServiceGetOrganizationUsageByModelResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("llmgw.v1.UsageAnalyticsService.GetOrganizationUsageByModel is not implemented"))
}
