...
const (
	...
	IAMServiceName = "trustedai.v1.IAMService"
)
...
// NewIAMServiceClient constructs a client for the trustedai.v1.IAMService service. By default, it
...
func NewIAMServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IAMServiceClient {
	...
	iAMServiceMethods := v1.File_proto_madsrc_trustedai_v1_iam_proto.Services().ByName("IAMService").Methods()
...
// CreateUser calls trustedai.v1.IAMService.CreateUser.
...
// GetUser calls trustedai.v1.IAMService.GetUser.
...
// GetUserByEmail calls trustedai.v1.IAMService.GetUserByEmail.
...
// GetUserByExternalID calls trustedai.v1.IAMService.GetUserByExternalID.
...
// GetCurrentUser calls trustedai.v1.IAMService.GetCurrentUser.
...
// ListUsersByOrganization calls trustedai.v1.IAMService.ListUsersByOrganization.
...
// UpdateUser calls trustedai.v1.IAMService.UpdateUser.
...
// DeleteUser calls trustedai.v1.IAMService.DeleteUser.
...
// CreateOrganization calls trustedai.v1.IAMService.CreateOrganization.
...
// GetOrganization calls trustedai.v1.IAMService.GetOrganization.
...
// GetOrganizationByName calls trustedai.v1.IAMService.GetOrganizationByName.
...
// ListOrganizations calls trustedai.v1.IAMService.ListOrganizations.
...
// UpdateOrganization calls trustedai.v1.IAMService.UpdateOrganization.
...
// DeleteOrganization calls trustedai.v1.IAMService.DeleteOrganization.
...
// CreateToken calls trustedai.v1.IAMService.CreateToken.
...
// ListUserTokens calls trustedai.v1.IAMService.ListUserTokens.
...
// RevokeToken calls trustedai.v1.IAMService.RevokeToken.
...
// IAMServiceHandler is an implementation of the trustedai.v1.IAMService service.
...
func NewIAMServiceHandler(svc IAMServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/trustedai.v1.IAMService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIAMServiceHandler) CreateUser(context.Context, *connect.Request[v1.IAMServiceCreateUserRequest]) (*connect.Response[v1.IAMServiceCreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.CreateUser is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetUser(context.Context, *connect.Request[v1.IAMServiceGetUserRequest]) (*connect.Response[v1.IAMServiceGetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetUser is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetUserByEmail(context.Context, *connect.Request[v1.IAMServiceGetUserByEmailRequest]) (*connect.Response[v1.IAMServiceGetUserByEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetUserByEmail is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetUserByExternalID(context.Context, *connect.Request[v1.IAMServiceGetUserByExternalIDRequest]) (*connect.Response[v1.IAMServiceGetUserByExternalIDResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetUserByExternalID is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetCurrentUser(context.Context, *connect.Request[v1.IAMServiceGetCurrentUserRequest]) (*connect.Response[v1.IAMServiceGetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) ListUsersByOrganization(context.Context, *connect.Request[v1.IAMServiceListUsersByOrganizationRequest]) (*connect.Response[v1.IAMServiceListUsersByOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.ListUsersByOrganization is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) UpdateUser(context.Context, *connect.Request[v1.IAMServiceUpdateUserRequest]) (*connect.Response[v1.IAMServiceUpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.UpdateUser is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) DeleteUser(context.Context, *connect.Request[v1.IAMServiceDeleteUserRequest]) (*connect.Response[v1.IAMServiceDeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.DeleteUser is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) CreateOrganization(context.Context, *connect.Request[v1.IAMServiceCreateOrganizationRequest]) (*connect.Response[v1.IAMServiceCreateOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.CreateOrganization is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetOrganization(context.Context, *connect.Request[v1.IAMServiceGetOrganizationRequest]) (*connect.Response[v1.IAMServiceGetOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetOrganization is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) GetOrganizationByName(context.Context, *connect.Request[v1.IAMServiceGetOrganizationByNameRequest]) (*connect.Response[v1.IAMServiceGetOrganizationByNameResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.GetOrganizationByName is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) ListOrganizations(context.Context, *connect.Request[v1.IAMServiceListOrganizationsRequest]) (*connect.Response[v1.IAMServiceListOrganizationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.ListOrganizations is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) UpdateOrganization(context.Context, *connect.Request[v1.IAMServiceUpdateOrganizationRequest]) (*connect.Response[v1.IAMServiceUpdateOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.UpdateOrganization is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) DeleteOrganization(context.Context, *connect.Request[v1.IAMServiceDeleteOrganizationRequest]) (*connect.Response[v1.IAMServiceDeleteOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.DeleteOrganization is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) CreateToken(context.Context, *connect.Request[v1.IAMServiceCreateTokenRequest]) (*connect.Response[v1.IAMServiceCreateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.CreateToken is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) ListUserTokens(context.Context, *connect.Request[v1.IAMServiceListUserTokensRequest]) (*connect.Response[v1.IAMServiceListUserTokensResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.ListUserTokens is not implemented"))
}
...
func (UnimplementedIAMServiceHandler) RevokeToken(context.Context, *connect.Request[v1.IAMServiceRevokeTokenRequest]) (*connect.Response[v1.IAMServiceRevokeTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("trustedai.v1.IAMService.RevokeToken is not implemented"))
}
