...
# Get the project root directory (parent of trustedai directory)
...
if ! go build -o "$BUILD_DIR/$OUTPUT_FILENAME" ./cmd/trustedai > "$BUILD_LOG" 2>&1; then
