 ...
 * For small amounts (< $0.01), shows up to 6 decimal places to avoid displaying $0.00.
...
export const formatCost = (costCents: number | bigint): string => {
  ...
  // If the cost is very small (less than $0.01), show up to 6 decimal places
  // to avoid displaying $0.00 for fractional cent costs
